...
/*!
 * \file
 * \brief Definition of generate_png_with_playwright variable.
 *
 * This file is generated from scripts/generate_png_with_playwright.py.
...
/*!
 * \brief Python script to generate PNG with Playwright.
 */
static constexpr std::string_view generate_png_with_playwright =
    R"("""Generate PNG with Playwright."""
