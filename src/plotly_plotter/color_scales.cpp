...
std::vector<std::pair<double, std::string>> blown() {
    return {
        {0.0, "#FDD4C6"},   // NOLINT(*-magic-numbers)
        {0.05, "#FBC5B3"},  // NOLINT(*-magic-numbers)
        {0.1, "#FAB7A0"},   // NOLINT(*-magic-numbers)
        {0.15, "#F8A88D"},  // NOLINT(*-magic-numbers)
        {0.2, "#F5997A"},   // NOLINT(*-magic-numbers)
        {0.25, "#F18B68"},  // NOLINT(*-magic-numbers)
        {0.3, "#EA7E58"},   // NOLINT(*-magic-numbers)
        {0.35, "#E37048"},  // NOLINT(*-magic-numbers)
        {0.4, "#DA643A"},   // NOLINT(*-magic-numbers)
        {0.45, "#CD5B32"},  // NOLINT(*-magic-numbers)
        {0.5, "#C0532B"},   // NOLINT(*-magic-numbers)
        {0.55, "#B34A24"},  // NOLINT(*-magic-numbers)
        {0.6, "#A6421C"},   // NOLINT(*-magic-numbers)
        {0.65, "#993B16"},  // NOLINT(*-magic-numbers)
        {0.7, "#8C3310"},   // NOLINT(*-magic-numbers)
        {0.75, "#7F2C0A"},  // NOLINT(*-magic-numbers)
        {0.8, "#712708"},   // NOLINT(*-magic-numbers)
        {0.85, "#632208"},  // NOLINT(*-magic-numbers)
        {0.9, "#551E08"},   // NOLINT(*-magic-numbers)
        {0.95, "#471908"},  // NOLINT(*-magic-numbers)
...
std::vector<std::pair<double, std::string>> red() {
    return {
        {0.0, "#FFD890"},   // NOLINT(*-magic-numbers)
        {0.05, "#FCC980"},  // NOLINT(*-magic-numbers)
        {0.1, "#F9B972"},   // NOLINT(*-magic-numbers)
        {0.15, "#F5A965"},  // NOLINT(*-magic-numbers)
        {0.2, "#F1995A"},   // NOLINT(*-magic-numbers)
        {0.25, "#EC8951"},  // NOLINT(*-magic-numbers)
        {0.3, "#E6784C"},   // NOLINT(*-magic-numbers)
        {0.35, "#DF6849"},  // NOLINT(*-magic-numbers)
        {0.4, "#D75748"},   // NOLINT(*-magic-numbers)
        {0.45, "#CD4847"},  // NOLINT(*-magic-numbers)
        {0.5, "#BF3E42"},   // NOLINT(*-magic-numbers)
        {0.55, "#B1343E"},  // NOLINT(*-magic-numbers)
        {0.6, "#A42939"},   // NOLINT(*-magic-numbers)
        {0.65, "#961E34"},  // NOLINT(*-magic-numbers)
        {0.7, "#89122F"},   // NOLINT(*-magic-numbers)
        {0.75, "#790D2C"},  // NOLINT(*-magic-numbers)
        {0.8, "#690B29"},   // NOLINT(*-magic-numbers)
        {0.85, "#590925"},  // NOLINT(*-magic-numbers)
        {0.9, "#4A0720"},   // NOLINT(*-magic-numbers)
        {0.95, "#3B051B"},  // NOLINT(*-magic-numbers)
        {1.0, "#2D0415"},   // NOLINT(*-magic-numbers)
    };
}

std::vector<std::pair<double, std::string>> red_full() {
    return {
        {0.0, "#FFFFFF"},   // NOLINT(*-magic-numbers)
        {0.05, "#F9F1CF"},  // NOLINT(*-magic-numbers)
        {0.1, "#FDDD9C"},   // NOLINT(*-magic-numbers)
        {0.15, "#FCC981"},  // NOLINT(*-magic-numbers)
        {0.2, "#F8B56E"},   // NOLINT(*-magic-numbers)
        {0.25, "#F3A05E"},  // NOLINT(*-magic-numbers)
        {0.3, "#EC8B52"},   // NOLINT(*-magic-numbers)
        {0.35, "#E5764B"},  // NOLINT(*-magic-numbers)
        {0.4, "#DC6048"},   // NOLINT(*-magic-numbers)
        {0.45, "#D04B48"},  // NOLINT(*-magic-numbers)
        {0.5, "#BF3E42"},   // NOLINT(*-magic-numbers)
        {0.55, "#AD303C"},  // NOLINT(*-magic-numbers)
        {0.6, "#9C2336"},   // NOLINT(*-magic-numbers)
        {0.65, "#8B142F"},  // NOLINT(*-magic-numbers)
        {0.7, "#770C2B"},   // NOLINT(*-magic-numbers)
        {0.75, "#620A27"},  // NOLINT(*-magic-numbers)
        {0.8, "#4E0721"},   // NOLINT(*-magic-numbers)
        {0.85, "#3B051A"},  // NOLINT(*-magic-numbers)
        {0.9, "#290412"},   // NOLINT(*-magic-numbers)
        {0.95, "#170309"},  // NOLINT(*-magic-numbers)
        {1.0, "#070203"},   // NOLINT(*-magic-numbers)
    };
...
std::vector<std::pair<double, std::string>> green_to_autumn() {
    return {
        {0.0, "#010404"},    // NOLINT(*-magic-numbers)
        {0.025, "#020D0C"},  // NOLINT(*-magic-numbers)
        {0.05, "#041815"},   // NOLINT(*-magic-numbers)
        {0.075, "#07241D"},  // NOLINT(*-magic-numbers)
        {0.1, "#0D3025"},    // NOLINT(*-magic-numbers)
        {0.125, "#0F3E2B"},  // NOLINT(*-magic-numbers)
        {0.15, "#0F4C2F"},   // NOLINT(*-magic-numbers)
        {0.175, "#135A32"},  // NOLINT(*-magic-numbers)
        {0.2, "#1E6931"},    // NOLINT(*-magic-numbers)
        {0.225, "#2D772E"},  // NOLINT(*-magic-numbers)
        {0.25, "#438431"},   // NOLINT(*-magic-numbers)
        {0.275, "#579133"},  // NOLINT(*-magic-numbers)
        {0.3, "#6C9D36"},    // NOLINT(*-magic-numbers)
        {0.325, "#81AA39"},  // NOLINT(*-magic-numbers)
        {0.35, "#95B749"},   // NOLINT(*-magic-numbers)
        {0.375, "#A8C35E"},  // NOLINT(*-magic-numbers)
        {0.4, "#BBD074"},    // NOLINT(*-magic-numbers)
        {0.425, "#CEDD89"},  // NOLINT(*-magic-numbers)
        {0.45, "#E0E9A4"},   // NOLINT(*-magic-numbers)
        {0.475, "#F1F4D2"},  // NOLINT(*-magic-numbers)
        {0.5, "#FFFFFF"},    // NOLINT(*-magic-numbers)
        {0.525, "#F7F3BF"},  // NOLINT(*-magic-numbers)
        {0.55, "#F4E473"},   // NOLINT(*-magic-numbers)
        {0.575, "#F5CF4D"},  // NOLINT(*-magic-numbers)
        {0.6, "#F4B93C"},    // NOLINT(*-magic-numbers)
        {0.625, "#F0A433"},  // NOLINT(*-magic-numbers)
        {0.65, "#EA8F32"},   // NOLINT(*-magic-numbers)
        {0.675, "#E07C34"},  // NOLINT(*-magic-numbers)
        {0.7, "#D26C31"},    // NOLINT(*-magic-numbers)
        {0.725, "#C35C2F"},  // NOLINT(*-magic-numbers)
        {0.75, "#B54D2D"},   // NOLINT(*-magic-numbers)
        {0.775, "#A53F2A"},  // NOLINT(*-magic-numbers)
        {0.8, "#933527"},    // NOLINT(*-magic-numbers)
        {0.825, "#802B22"},  // NOLINT(*-magic-numbers)
        {0.85, "#6E231D"},   // NOLINT(*-magic-numbers)
        {0.875, "#5C1A18"},  // NOLINT(*-magic-numbers)
        {0.9, "#4B1116"},    // NOLINT(*-magic-numbers)
        {0.925, "#3A0816"},  // NOLINT(*-magic-numbers)
        {0.95, "#290413"},   // NOLINT(*-magic-numbers)
        {0.975, "#170309"},  // NOLINT(*-magic-numbers)
        {1.0, "#070203"},    // NOLINT(*-magic-numbers)
    };
}

std::vector<std::pair<double, std::string>> green_to_autumn_on_yellow() {
    return {
        {0.0, "#010404"},    // NOLINT(*-magic-numbers)
        {0.025, "#020D0C"},  // NOLINT(*-magic-numbers)
        {0.05, "#041815"},   // NOLINT(*-magic-numbers)
        ...
        {0.4, "#BBD074"},    // NOLINT(*-magic-numbers)
        {0.425, "#CEDD89"},  // NOLINT(*-magic-numbers)
        {0.45, "#DEE89C"},   // NOLINT(*-magic-numbers)
        {0.475, "#EAEFA9"},  // NOLINT(*-magic-numbers)
        {0.5, "#F3F3B5"},    // NOLINT(*-magic-numbers)
        {0.525, "#F2ED9F"},  // NOLINT(*-magic-numbers)
        {0.55, "#F1E37D"},   // NOLINT(*-magic-numbers)
        {0.575, "#F1D062"},  // NOLINT(*-magic-numbers)
        {0.6, "#F0BB4E"},    // NOLINT(*-magic-numbers)
        {0.625, "#EEA53F"},  // NOLINT(*-magic-numbers)
        {0.65, "#E98F36"},   // NOLINT(*-magic-numbers)
        {0.675, "#E07C34"},  // NOLINT(*-magic-numbers)
        {0.7, "#D26C31"},    // NOLINT(*-magic-numbers)
        {0.725, "#C35C2F"},  // NOLINT(*-magic-numbers)
        {0.75, "#B54D2D"},   // NOLINT(*-magic-numbers)
...
std::vector<std::pair<double, std::string>> blue_to_autumn() {
    return {
        {0.0, "#04010E"},    // NOLINT(*-magic-numbers)
        {0.025, "#0A061D"},  // NOLINT(*-magic-numbers)
        {0.05, "#110F2C"},   // NOLINT(*-magic-numbers)
        {0.075, "#161A3D"},  // NOLINT(*-magic-numbers)
        {0.1, "#1A254E"},    // NOLINT(*-magic-numbers)
        {0.125, "#1C325F"},  // NOLINT(*-magic-numbers)
        {0.15, "#1A4070"},   // NOLINT(*-magic-numbers)
        {0.175, "#164E7F"},  // NOLINT(*-magic-numbers)
        {0.2, "#125E8A"},    // NOLINT(*-magic-numbers)
        {0.225, "#0F6D94"},  // NOLINT(*-magic-numbers)
        {0.25, "#127D9D"},   // NOLINT(*-magic-numbers)
        {0.275, "#1C8DA5"},  // NOLINT(*-magic-numbers)
        {0.3, "#2B9CAE"},    // NOLINT(*-magic-numbers)
        {0.325, "#3BACB6"},  // NOLINT(*-magic-numbers)
        {0.35, "#4CBBBE"},   // NOLINT(*-magic-numbers)
        {0.375, "#5ECAC5"},  // NOLINT(*-magic-numbers)
        {0.4, "#71DACC"},    // NOLINT(*-magic-numbers)
        {0.425, "#85E9D2"},  // NOLINT(*-magic-numbers)
        {0.45, "#A3F5DA"},   // NOLINT(*-magic-numbers)
        {0.475, "#D5FAEA"},  // NOLINT(*-magic-numbers)
        {0.5, "#FFFFFF"},    // NOLINT(*-magic-numbers)
        {0.525, "#F7F3BF"},  // NOLINT(*-magic-numbers)
        {0.55, "#F4E473"},   // NOLINT(*-magic-numbers)
        {0.575, "#F5CF4D"},  // NOLINT(*-magic-numbers)
...
std::vector<std::pair<double, std::string>> blue_to_autumn_on_green() {
    return {
        {0.0, "#04010E"},    // NOLINT(*-magic-numbers)
        {0.025, "#0A061D"},  // NOLINT(*-magic-numbers)
        {0.05, "#110F2C"},   // NOLINT(*-magic-numbers)
        ...
        {0.4, "#71DACC"},    // NOLINT(*-magic-numbers)
        {0.425, "#85E9D2"},  // NOLINT(*-magic-numbers)
        {0.45, "#9BF6D7"},   // NOLINT(*-magic-numbers)
        {0.475, "#B4FCD4"},  // NOLINT(*-magic-numbers)
        {0.5, "#CFFDCD"},    // NOLINT(*-magic-numbers)
        {0.525, "#DBF4B2"},  // NOLINT(*-magic-numbers)
        {0.55, "#ECE581"},   // NOLINT(*-magic-numbers)
        {0.575, "#F1D062"},  // NOLINT(*-magic-numbers)
        {0.6, "#F0BB4E"},    // NOLINT(*-magic-numbers)
        {0.625, "#EEA53F"},  // NOLINT(*-magic-numbers)
        {0.65, "#E98F36"},   // NOLINT(*-magic-numbers)
...
std::vector<std::pair<double, std::string>> green_to_red() {
    return {
        {0.0, "#010404"},    // NOLINT(*-magic-numbers)
        {0.025, "#020D0C"},  // NOLINT(*-magic-numbers)
        {0.05, "#041815"},   // NOLINT(*-magic-numbers)
        ...
        {0.475, "#F1F4D2"},  // NOLINT(*-magic-numbers)
        {0.5, "#FFFFFF"},    // NOLINT(*-magic-numbers)
        {0.525, "#F9F1CF"},  // NOLINT(*-magic-numbers)
        {0.55, "#FDDE9C"},   // NOLINT(*-magic-numbers)
        {0.575, "#FCC980"},  // NOLINT(*-magic-numbers)
        {0.6, "#F8B56E"},    // NOLINT(*-magic-numbers)
        {0.625, "#F3A05E"},  // NOLINT(*-magic-numbers)
        {0.65, "#EC8B52"},   // NOLINT(*-magic-numbers)
        {0.675, "#E5764B"},  // NOLINT(*-magic-numbers)
        {0.7, "#DC6048"},    // NOLINT(*-magic-numbers)
        {0.725, "#D14B48"},  // NOLINT(*-magic-numbers)
        {0.75, "#BF3E42"},   // NOLINT(*-magic-numbers)
        {0.775, "#AD313C"},  // NOLINT(*-magic-numbers)
        {0.8, "#9C2336"},    // NOLINT(*-magic-numbers)
        {0.825, "#8B1430"},  // NOLINT(*-magic-numbers)
        {0.85, "#770C2B"},   // NOLINT(*-magic-numbers)
        {0.875, "#620A27"},  // NOLINT(*-magic-numbers)
        {0.9, "#4E0721"},    // NOLINT(*-magic-numbers)
        {0.925, "#3B051B"},  // NOLINT(*-magic-numbers)
        {0.95, "#290413"},   // NOLINT(*-magic-numbers)
        {0.975, "#170309"},  // NOLINT(*-magic-numbers)
        {1.0, "#070203"},    // NOLINT(*-magic-numbers)
    };
...
std::vector<std::pair<double, std::string>> green_to_red_on_yellow() {
    return {
        {0.0, "#010404"},    // NOLINT(*-magic-numbers)
        {0.025, "#020D0C"},  // NOLINT(*-magic-numbers)
        {0.05, "#041815"},   // NOLINT(*-magic-numbers)
        ...
        {0.475, "#EAEFA9"},  // NOLINT(*-magic-numbers)
        {0.5, "#F3F3B5"},    // NOLINT(*-magic-numbers)
        {0.525, "#FBE9A4"},  // NOLINT(*-magic-numbers)
        {0.55, "#FEDC93"},   // NOLINT(*-magic-numbers)
        {0.575, "#FCC980"},  // NOLINT(*-magic-numbers)
        {0.6, "#F8B56E"},    // NOLINT(*-magic-numbers)
        {0.625, "#F3A05E"},  // NOLINT(*-magic-numbers)
        {0.65, "#EC8B52"},   // NOLINT(*-magic-numbers)
...
std::vector<std::pair<double, std::string>> blue_to_red() {
    return {
        {0.0, "#04010E"},    // NOLINT(*-magic-numbers)
        {0.025, "#0A061D"},  // NOLINT(*-magic-numbers)
        {0.05, "#110F2C"},   // NOLINT(*-magic-numbers)
...
std::vector<std::pair<double, std::string>> blue_to_red_on_green() {
    return {
        {0.0, "#04010E"},    // NOLINT(*-magic-numbers)
        {0.025, "#0A061D"},  // NOLINT(*-magic-numbers)
        {0.05, "#110F2C"},   // NOLINT(*-magic-numbers)
        ...
        {0.425, "#85E9D2"},  // NOLINT(*-magic-numbers)
        {0.45, "#9BF6D7"},   // NOLINT(*-magic-numbers)
        {0.475, "#B5FBD3"},  // NOLINT(*-magic-numbers)
        {0.5, "#DAFBC4"},    // NOLINT(*-magic-numbers)
        {0.525, "#EBEFA9"},  // NOLINT(*-magic-numbers)
        {0.55, "#FBDD93"},   // NOLINT(*-magic-numbers)
        {0.575, "#FCC980"},  // NOLINT(*-magic-numbers)
        {0.6, "#F8B56E"},    // NOLINT(*-magic-numbers)
        {0.625, "#F3A05E"},  // NOLINT(*-magic-numbers)
        {0.65, "#EC8B52"},   // NOLINT(*-magic-numbers)
