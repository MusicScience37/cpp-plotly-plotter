...
line::line(const data_table& data) : figure_builder_base(data) {}

line& line::x(std::string value) {
    x_ = std::move(value);
    return *this;
}

line& line::y(std::string value) {
    y_ = std::move(value);
    return *this;
}

line& line::group(std::string value) {
    set_group(std::move(value));
    return *this;
}

line& line::title(std::string value) {
    set_title(std::move(value));
    return *this;
}

void line::configure_axes(figure& fig) const {
    if (!x_.empty()) {
...
std::string line::default_title() const { return y_; }

void line::add_trace_without_grouping(figure& fig) const {
...
void line::add_trace_for_group(figure& figure,
