...
/*!
 * \file
 * \brief Example to create box plots using figure builders.
 */
...
int main() {
    ...
    const plotly_plotter::figure figure =
        plotly_plotter::figure_builders::box(data)
            // Set y.
            .y("y")
            // Optionally set grouping of boxes.
            .group("group")
    ...
    plotly_plotter::write_html(
        "boxes_create_boxes_using_figure_builder.html", figure);
}
