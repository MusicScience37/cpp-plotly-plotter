...
/*!
 * \file
 * \brief Example to use subplot_column function of a figure builder.
 */
...
int main() {
    ...
    const plotly_plotter::figure figure =
        plotly_plotter::figure_builders::line(data)
            .x("x")
            .y("y")
            // Set grouping using subplot_column function.
            .subplot_column("Group")
            .title(
                "Example to Use <b>subplot_column</b> Function of a Figure "
                "Builder")
            .create();
