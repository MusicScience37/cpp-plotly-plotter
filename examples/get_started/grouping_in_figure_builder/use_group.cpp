...
/*!
 * \file
 * \brief Example to use group function of a figure builder.
 */
...
int main() {
    ...
    const plotly_plotter::figure figure =
        plotly_plotter::figure_builders::line(data)
            .x("x")
            .y("y")
            // Set grouping of lines using group function.
            .group("Group")
            .title("Example to Use <b>group</b> Function of a Figure Builder")
            .create();

    // Save the figure to a HTML file.
    plotly_plotter::write_html(
        "get_started_grouping_in_figure_builder_use_group.html", figure);
}
