...
/*!
 * \file
 * \brief Test of playwright_converter class.
 */
...
TEST_CASE("plotly_plotter::io::playwright_converter") {
    ...
    auto& converter = plotly_plotter::io::playwright_converter::get_instance();

    SECTION("create a PDF file") {
        const std::string html_file_path = "playwright_converter_pdf_test.html";
        const std::string pdf_file_path = "playwright_converter_pdf_test.pdf";
    ...
    SECTION("create a PNG file") {
        const std::string html_file_path = "playwright_converter_png_test.html";
        const std::string png_file_path = "playwright_converter_png_test.png";
        constexpr std::size_t width = 1600;
        constexpr std::size_t height = 900;
