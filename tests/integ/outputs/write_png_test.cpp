...
/*!
 * \file
 * \brief Test of write_png function.
 */
...
TEST_CASE("plotly_plotter::write_png") {
    // Figure for test.
    ...
    SECTION("create a PDF file") {
        const std::string png_file_path = "write_png_test.png";
...
#else
        CHECK_FALSE(plotly_plotter::is_png_supported());
        CHECK_THROWS(
            plotly_plotter::write_png(png_file_path, figure, width, height));
#endif
    }
