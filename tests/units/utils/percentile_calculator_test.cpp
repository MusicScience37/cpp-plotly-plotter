...
TEST_CASE("plotly_plotter::utils::percentile_calculator") {
    using plotly_plotter::utils::percentile_calculator;
    ...
    SECTION("calculate percentiles of double values in Eigen") {
